...
Im allgemeinen macht Kerberos aber genau das was es soll und seine Popularität zeigt auch, dass es diese Aufgabe sehr zufriedenstellend löst.

\subsubsection{Pleasant Password Server}
\subsubsection{CyberArk}
\subsubsection{Hashicorp Vault}
\subsubsection{Das Passwort als Problem}
