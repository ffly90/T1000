...
\subsubsection{Das Passwort Dilemma}
...
\begin{itemize}
	...
	\item Passwörter können über sogenannte Brute-force Angriffe ``erraten`` werden. Um diese Angriffe durchzuführen gibt es spezielle Programme, die so lange alle möglichen Kobinationen an Tastaturzeichen ausprobieren, bis sie das Passwort herausgefunden haben.
\end{itemize}
\subsubsection{Hashicorp Vault}
Bei Hashicorp Vault handelt es sich um ein vollumfängliches Secrets Management System 
