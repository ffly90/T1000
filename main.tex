...
\begin{figure}[h]
	...
	\caption[Ablauf Verslüsselung]{Ablauf einer Verschlüsselung mit asymmetrischer Verschlüsselung\cite[S. 6]{crypto}}
	\label{fig:crypt}
\end{figure}
